...
<qgis maxScale="0" minScale="1e+08" version="3.4.8-Madeira" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories">
  <flags>
  ...
  <pipe>
    <rasterrenderer alphaBand="-1" type="paletted" band="1" opacity="1">
      ...
      <colorPalette>
        <paletteEntry alpha="255" color="#440154" label="MLC Base" value="1"/>
        <paletteEntry alpha="255" color="#20908d" label="DTC" value="10"/>
        <paletteEntry alpha="255" color="#fde725" label="MLC Base, DTC" value="11"/>
      </colorPalette>
    ...
    <huesaturation colorizeStrength="100" grayscaleMode="0" saturation="0" colorizeOn="0" colorizeGreen="128" colorizeRed="255" colorizeBlue="128"/>
