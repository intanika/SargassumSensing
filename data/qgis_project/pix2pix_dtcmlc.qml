...
<qgis minScale="1e+08" version="3.4.12-Madeira" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0">
  ...
  <pipe>
    <rasterrenderer band="2" alphaBand="-1" opacity="1" type="paletted">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <colorPalette>
        <paletteEntry alpha="255" value="1" color="#440154" label="MLC 10%"/>
        <paletteEntry alpha="255" value="10" color="#20908d" label="DTC"/>
        <paletteEntry alpha="255" value="11" color="#fde725" label="MLC 10%, DTC"/>
      </colorPalette>
